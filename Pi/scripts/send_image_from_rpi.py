...
def send_image(bin_filename, verbose=False, direct = False, delay = False):
    """
    ...
    if direct:
        ...
        GPIO.setup(rst_n, GPIO.IN) # Once booted, the Pi should not need to drive reset
        GPIO.cleanup()
    else:
        bus = smbus.SMBus(1)
...
if __name__ == "__main__":
    ...
    send_image(args.bin_filename, args.verbose, args.direct, args.delay)
